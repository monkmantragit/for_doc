                ...
                {headerGroup.headers.map((header: Header<TData, unknown>) => {
                  ...
                  return (
                    <th
                      key={header.id}
                      className={cn(
                        'px-2 py-3.5 text-left text-sm font-semibold text-gray-900 sm:whitespace-nowrap',
                  ...
                  <tr className="hover:bg-gray-50">
                    {row.getVisibleCells().map((cell: Cell<TData, unknown>, idx: number) => (
                      <td
                        key={cell.id}
                        className={cn(
                          'whitespace-nowrap px-2 py-4 text-sm text-gray-900 max-sm:px-2 max-sm:py-3 max-sm:text-xs',
